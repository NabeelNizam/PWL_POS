...
Route::middleware(['auth'])->group(function () { // artinya semua route di dalam group ini harus login dulu
    ...
    Route::group(['prefix' => 'profile'], function () {
        ...
        Route::get('/import', [ProfileController::class, 'import']);
        Route::post('/import_ajax', [ProfileController::class, 'import_ajax']); 
    });
    ...
    Route::group(['prefix' => 'stok', 'middleware' => ['authorize:ADM']], function () {
        ...
        Route::post('/update_jumlah', [StokController::class, 'updateJumlah']);
        Route::post('/update_jumlah_manual', [StokController::class, 'updateJumlahManual']);
        Route::post('/reset_jumlah', [StokController::class, 'resetJumlah']);
